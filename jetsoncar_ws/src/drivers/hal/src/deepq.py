...
class DeepQ:
    ...
    def createRegularizedModel(self, inputs, outputs, hiddenLayers, activationType, learningRate):
        ...
        if len(hiddenLayers) == 0:
            model.add(Dense(self.output_size, input_shape=(self.input_size,), activation="linear", kernel_initializer='lecun_uniform', bias=bias))
        else :
    ...
    # Experience Replay to prevent memorizing coralations
